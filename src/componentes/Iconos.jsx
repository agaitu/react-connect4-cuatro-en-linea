export function GearIcon () {
  return (
    <>
      <svg version='1.1' id='Layer_1' width='32px' height='32px' viewBox='0 0 64 64' enableBackground='new 0 0 64 64'>
        <g>
          <polygon
            fill='none' stroke='#000000' strokeWidth='2' strokeMiterlimit='10' points='32,1 26,1 26,10 20,12 14,6 6,14 12,20
